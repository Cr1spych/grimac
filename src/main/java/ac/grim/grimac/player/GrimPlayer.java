...
public class GrimPlayer implements GrimUser {
    ...
    public int flyingCount = 0;
    public int powderSnowFrozenTicks = 0;
    @Setter public int swings = 0;
    @Getter @Setter public int lastCps = 0;
    public int clicks = 0;
    public int stage = 0;
    public int outliers = 0;
    @Setter  public int movementPackets = 0;
    @Getter public long lastMovePacketTimestamp = 0;
    ...
    public boolean addTransactionResponse(short id) {
        ...
        if (hasID) {
            ...
            if (skipped > 0 && System.currentTimeMillis() - joinTime > 5000)
                checkManager.getPacketCheck(TransactionOrder.class).fail("skipped: " + skipped);
